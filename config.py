...
#                '2018.03.19','2018.03.20']
    ...
    if 'trsfresh_from_variations' in entries:
        trsfresh_from_variations = entries['trsfresh_from_variations']
    else:
        trsfresh_from_variations = False
    if 'var_feats_keys' in entries:
        var_feats_keys = entries['var_feats_keys']
    else:
        var_feats_keys = []#[i for i in range(68,93)]
...
def retrieve_config(config_name):
    """  """
    config_filename = config_directory+config_name+".config"
