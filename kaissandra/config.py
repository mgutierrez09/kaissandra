...
def configuration_trader(*ins):
    ...
    config_name = 'T6N504060TESTv1'#'TESTPARAMUPDATE5'#'TTEST01010FS2NYREDOK2K52145314SR'#'TTESTv3'#
    config_filename = local_vars.config_directory+config_name+config_extension
    
    if not os.path.exists(config_filename):
        
        numberNetworks = 6
        IDresults = ['R500AL','R500BS']+['R400AL','R400BS']+['R600AL','R600BS']
        IDweights = [['W01010PS2NYk1K2A','W01010PS2NYk2K2A','WRNN01010k1K5A','WRNN01010k2K5A'],['W01010PS2NYk1K2A','W01010PS2NYk2K2A','WRNN01010k1K5A','WRNN01010k2K5A'],
                     ['W01010PS2NYk1K2A','W01010PS2NYk2K2A','WRNN01010k1K5A','WRNN01010k2K5A'],['W01010PS2NYk1K2A','W01010PS2NYk2K2A','WRNN01010k1K5A','WRNN01010k2K5A'],
        ...
        list_name = ['R500ALM2SP60','R500BSM2SP60']+['R400ALM2SP60','R400BSM2SP60']+['R0600ALM2SP60','R0600BSM2SP60']
        
        list_spread_ranges = [{'sp':[5]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               'th':[(.5, .5)]+[(0.5, 0.58), (0.5, 0.58), (0.5, 0.58), (0.5, 0.58), (0.54, 0.58), (0.55, 0.58), (0.58, 0.58), (0.58, 0.58), (0.55, 0.59), (0.54, 0.6), (0.54, 0.6), 
                               ...
                               'dir':'ASKS'},
                              {'sp':[5]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               ...
                               'dir':'BIDS'}]+\
                            [{'sp':[5]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.5)]+[(0.55, 0.57), (0.55, 0.58), (0.55, 0.58), (0.56, 0.58), (0.5, 0.6), (0.5, 0.6), (0.51, 0.6), (0.52, 0.6), (0.55, 0.6), (0.56, 0.6), (0.57, 0.6), (0.57, 0.61), 
                                       (0.57, 0.61), (0.57, 0.61), (0.52, 0.63), (0.57, 0.62), (0.54, 0.63), (0.57, 0.63), (0.57, 0.63), (0.57, 0.63), (0.59, 0.63), (0.61, 0.63), (0.61, 0.63), (0.62, 0.63), (0.7, 0.61), 
                                       (0.7, 0.61), (0.66, 0.63), (0.66, 0.63), (0.58, 0.65), (0.7, 0.63), (0.7, 0.63), (0.7, 0.63), (0.7, 0.63), (0.7, 0.63), (0.73, 0.63), (0.73, 0.63), (0.73, 0.64), (0.73, 0.64), 
                                       (0.73, 0.64), (0.73, 0.64), (0.73, 0.64), (0.73, 0.64), (0.73, 0.64), (0.73, 0.64), (0.73, 0.64), (0.73, 0.64)],
                               'mar':[(0,0.0)]+[(0,0.02) for _ in range(46)],
                               'dir':'ASKS'},
                              {'sp':[5]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.5)]+[(0.57, 0.57), (0.6, 0.57), (0.52, 0.6), (0.53, 0.6), (0.55, 0.6), (0.57, 0.6), (0.58, 0.6), (0.59, 0.6), (0.59, 0.6), (0.6, 0.6), (0.61, 0.6), (0.62, 0.6), (0.63, 0.6), 
                                      (0.63, 0.6), (0.67, 0.59), (0.67, 0.59), (0.67, 0.6), (0.67, 0.6), (0.67, 0.6), (0.67, 0.6), (0.67, 0.6), (0.67, 0.6), (0.67, 0.6), (0.67, 0.6), (0.69, 0.6), (0.69, 0.6), 
                                      (0.69, 0.6), (0.69, 0.6), (0.71, 0.6), (0.71, 0.6), (0.71, 0.6), (0.71, 0.6), (0.71, 0.6), (0.71, 0.6), (0.75, 0.6), (0.75, 0.6), (0.75, 0.6), (0.76, 0.6), (0.76, 0.6), (0.76, 0.6), 
                                      (0.76, 0.6), (0.76, 0.6), (0.76, 0.6), (0.76, 0.6), (0.76, 0.6), (0.76, 0.6)],
                               'mar':[(0,0.0)]+[(0,0.02) for _ in range(46)],
                               'dir':'BIDS'}]+\
                            [{'sp':[5]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                              'th': [(0.5, 0.5)]+[(0.57, 0.58), (0.51, 0.59), (0.51, 0.6), (0.51, 0.6), (0.51, 0.6), (0.51, 0.6), (0.51, 0.6), (0.56, 0.6), (0.56, 0.6), (0.56, 0.6), (0.56, 0.6), (0.57, 0.6), (0.58, 0.6), 
                               ...
                               'dir':'ASKS'},
                              {'sp':[5]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.5)]+[(0.52, 0.62), (0.53, 0.62), (0.64, 0.61), (0.64, 0.61), (0.65, 0.61), (0.66, 0.61), (0.67, 0.61), (0.68, 0.61), (0.63, 0.62), (0.63, 0.62), (0.68, 0.62), (0.68, 0.62), 
        ...
        mWs = [30, 30]+[60,60]+[100,100]
        nExSs = [300, 300]+[600,600]+[1000,1000]
        ...
        IDepoch = [[5,2,14,14], [5,3,14,14], [5,2,14,14], [5,3,14,14], [14,14,19,19], [14,14,19,19]]
        netNames = ['500AL', '500BS']+['400AL', '400BS']+['600AL', '600BS']
        ...
        list_max_lots_per_pos = [.11 for i in range(numberNetworks)]
