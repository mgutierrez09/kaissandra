...
def configuration_trader(*ins):
    ...
    config_name = 'T6N504060v2'#'TESTPARAMUPDATE5'#'TTEST01010FS2NYREDOK2K52145314SR'#'TTESTv3'#
    config_filename = local_vars.config_directory+config_name+config_extension
    ...
    if not os.path.exists(config_filename):
        ...
        list_spread_ranges = [{'sp':[0]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                              ...
                              {'sp':[0]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               ...
                               'dir':'BIDS'}]+\
                            [{'sp':[0]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.54)]+[(0.55, 0.57), (0.55, 0.58), (0.55, 0.58), (0.56, 0.58), (0.5, 0.6), (0.5, 0.6), (0.51, 0.6), (0.52, 0.6), (0.55, 0.6), (0.56, 0.6), (0.57, 0.6), (0.57, 0.61), 
                               ...
                               'dir':'ASKS'},
                              {'sp':[0]+[round(10*i)/10 for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.54)]+[(0.57, 0.57), (0.6, 0.57), (0.52, 0.6), (0.53, 0.6), (0.55, 0.6), (0.57, 0.6), (0.58, 0.6), (0.59, 0.6), (0.59, 0.6), (0.6, 0.6), (0.61, 0.6), (0.62, 0.6), (0.63, 0.6), 
        ...
        mWs = [500, 500]+[400,400]+[600,600]
        nExSs = [5000, 5000]+[4000,4000]+[6000,6000]
