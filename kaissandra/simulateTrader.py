...
############################ WARNING!!!! ##############################################        
    ...
    def close_position(self, date_time, ass, idx, s, lot_ratio=None, partial_close=False):
        ...
        direction = self.list_opened_pos_per_str[s][self.map_ass2pos_str[s][idx]].direction
        GROI_or, ROI_or, spread, pos_info = self.get_rois(idx, s, 
                                                          date_time=date_time,
                                                          roi_ratio=roi_ratio,
                                                          ass=ass)
...
if __name__ == '__main__':
    ...
    numberNetwors = 2
    list_name = ['R01040ORPSAL2M2SNP60', 'R01040ORPSBS2M2SNP60']
    ...
    if not spreads_per_asset:
        list_IDresults = ['R01040ORPS2NNCMF181112T200424ALk12K2K5E1419','R01040ORPS2NNCMF181112T200424BSk12K2K5E1419']
        ...
        list_spread_ranges = [[{'sp':[0]+[round_num(i,10) for i in np.linspace(.5,5,num=46)],
                                'th': [(0.5, 0.55)]+[(0.56, 0.6), (0.59, 0.6), (0.62, 0.6), (0.59, 0.61), (0.62, 0.61), (0.58, 0.62), (0.59, 0.62), (0.58, 0.63), (0.58, 0.63), (0.58, 0.63), (0.59, 0.63), (0.6, 0.63), 
                                       (0.62, 0.63), (0.59, 0.64), (0.59, 0.64), (0.6, 0.64), (0.62, 0.64), (0.59, 0.65), (0.59, 0.65), (0.59, 0.65), (0.6, 0.65), (0.62, 0.65), (0.62, 0.65), (0.62, 0.65), (0.67, 0.65), 
                                       (0.67, 0.65), (0.67, 0.65), (0.67, 0.65), (0.67, 0.65), (0.67, 0.65), (0.67, 0.66), (0.67, 0.66), (0.67, 0.66), (0.67, 0.66), (0.67, 0.66), (0.67, 0.66), (0.73, 0.66), (0.73, 0.66), 
                                       (0.73, 0.66), (0.73, 0.66), (0.73, 0.66), (0.73, 0.66), (0.73, 0.66), (0.73, 0.66), (0.73, 0.66), (0.73, 0.66)],
                               'mar':[(0,0.0)]+[(0,0.02) for _ in range(46)]} for _ in assets],
                              [{'sp':[0]+[round_num(i,10) for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.55)]+[(0.56, 0.61), (0.58, 0.61), (0.62, 0.61), (0.64, 0.61), (0.65, 0.61), (0.65, 0.61), (0.66, 0.61), (0.66, 0.61), (0.67, 0.61), (0.68, 0.61), (0.77, 0.59), (0.77, 0.59), 
                                      (0.71, 0.61), (0.76, 0.6), (0.76, 0.6), (0.76, 0.6), (0.76, 0.61), (0.76, 0.61), (0.76, 0.61), (0.76, 0.61), (0.76, 0.61), (0.83, 0.58), (0.83, 0.58), (0.83, 0.58), (0.83, 0.58), 
                                      (0.83, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), (0.84, 0.58), 
                                      (0.84, 0.58), (0.84, 0.58), (0.84, 0.59), (0.84, 0.59), (0.84, 0.59), (0.84, 0.59), (0.84, 0.59), (0.84, 0.59)],
                               'mar':[(0,0.0)]+[(0,0.02) for _ in range(46)]} for _ in assets]]
        margin = 0.0
        init_margin = 0.0
        list_lb_mc_ext = [.5, .5]
...
#                    EXIT = trader.skip_positions(original_exit_time)
                # check if there is a position change opportunity
                    ...
                    if trader.next_candidate!= None and trader.is_opened_strategy(ass_idx):# and bid==trader.next_candidate.entry_bid and ask==trader.next_candidate.entry_ask
                        # get current ROIs
                        str_idx = name2str_map[trader.next_candidate.strategy]
                        curr_GROI, curr_ROI, curr_spread, _ = trader.get_rois(ass_idx, str_idx, date_time=DateTime, roi_ratio=1)
                        # extend position
...
#                                    approached = 0
                    ...
                    if trader.next_candidate!= None and trader.is_opened_strategy(ass_idx):
                        ...
                        elif -curr_GROI<qurantine_thr-curr_spread and trader.list_quarantined_pos[str_idx][trader.map_ass2pos_str[str_idx][ass_idx]]['on']:
                            # dequarantine
