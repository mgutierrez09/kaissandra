...
if __name__ == '__main__':
    ...
    if not spreads_per_asset:
        list_IDresults = ['R01100PS2CMF181112T200424ALk12K2K5E19','R01100PS2CMF181112T200424BSk12K2K5E19']
        ...
        list_spread_ranges = [[{'sp':[0]+[round_num(i,10) for i in np.linspace(.5,5,num=46)],
                                'th': [(0.5, 0.55)]+[(0.54, 0.56), (0.56, 0.56), (0.54, 0.58), (0.6, 0.58), (0.63, 0.58), (0.63, 0.58), (0.63, 0.58), (0.63, 0.58), (0.63, 0.58), (0.67, 0.58), (0.67, 0.58), 
                                       ...
                                       (0.83, 0.59), (0.83, 0.59)],
                               'mar':[(0,0.0)]+[(0,0.04) for _ in range(46)]} for _ in assets],
                              [{'sp':[0]+[round_num(i,10) for i in np.linspace(.5,5,num=46)],
                               'th': [(0.5, 0.55)]+[(0.54, 0.55), (0.54, 0.56), (0.54, 0.56), (0.54, 0.56), (0.63, 0.56), (0.63, 0.56), (0.63, 0.56), (0.66, 0.56), (0.66, 0.56), (0.66, 0.56), (0.66, 0.56), 
