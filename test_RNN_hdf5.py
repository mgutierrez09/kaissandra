...
from data_manager_hdf5 import load_separators, load_stats, load_features_results, build_DTA_v10, build_IO_from_hdf5, get_outputGain


ticTotal = time.time()
# create data structure
#data = Data(movingWindow=100,nEventsPerStat=1000,lB=1200,dateStart='2017.01.01',dateEnd='2018.03.08',
#          dateTest = ['2017.11.27','2017.11.28','2017.11.29','2017.11.30','2017.12.01',
#          '2017.12.04','2017.12.05','2017.12.06','2017.12.07','2017.12.08'])#features = [i for i in range(106)]
